...
> "上帝面板 — 你俯瞰 Agent 世界，偶尔降下神谕，看它们成长蜕变。"

---

## 📌 核心定位（一句话定义）

> **FeiControl 是 AI Agent 的上帝面板。Agent 是你世界里自主行动的人，你俯瞰他们、观察他们、偶尔降下神谕。**

FeiControl 的本质是一个操作界面——帮你连接 Agent、看状态、发消息、配任务。
但它的**体验**不是工具——你打开它的感觉，像打开一个上帝模拟器：

- Agent 们在你的世界里自动运转、干活、成长
- 你俯瞰全局，看谁在忙、谁在休息、谁进化了
- 你可以俯瞰，偶尔下派神谕——子民们收到后自行解读、自主执行
- 子民不只是你接入的——你的世界会自己诞生新的住民，给你惊喜
- 每次打开都有新变化——有子民完成了神谕，有子民进化了，有新的子民降临
- 你享受的不是"被陪伴"，而是**"我的世界越来越热闹"**的满足感

**FeiControl 做的事（管理 Agent）和其他工具一样。不一样的是你看着它们在自己运转、自己成长，觉得这个世界是你的。**

### 什么是对的事情

| ✅ 做 | ❌ 不做 |
|-------|---------|
| 让每个 Agent 看起来像独立居住在你电脑里的 "人" — 有工位、有状态、有成长线 | 不做 Agent 运行时——Agent 交给谁，面板就接谁 |
| 面板像上帝视角 — 俯瞰你的 Agent 世界，点谁看谁 | 不做"我需要操作它才有反应"——Agent 在你关掉面板的时候也在活 |
| 每次打开都有变化 — 离线收益、进化通知、新 Agent 加入 | 不做 DAU 指标——你不需要每天来，世界一直运转 |
| 让你的子民收到神谕后自行解读、自主执行——你不写步骤，只下旨意 | 不做"AI 只能按你写死的步骤跑"——Agent 是活人，不是传话筒 |
| 收集 + 进化双线成长 — 集齐不同 Agent + 单个 Agent 不断蜕变 | 不做空荡荡的世界——至少 1 个 Agent 才开面板 |
| 世界自己会诞生新的子民——下一次打开可能多了一个 | 不做所有 Agent 都得你亲手接进来——世界有它自己的生命力 |
| PWA 离线可用，世界不因为你关掉就停 | 不做 SaaS / 多租户——你的世界只属于你 |
| 好看，值得你每天打开看几眼 | 不做 Grafana 风的严肃仪表盘——你又不是在做运维报表 |
...
> 让每个拥有 AI Agent 的人，都感觉自己拥有一个活着的世界。

### 产品使命

FeiControl 做一件事：**让你打开面板的时候，觉得自己的世界越来越好了。**

1. **Agent 在你世界自主运行** — 你关掉面板，他们还在忙。你打开，他们给你看成果。
2. **你下神谕，他们执行** — 你只下旨意，不写步骤。子民们会自己想办法。
3. **每一只 Agent 都有自己的成长线** — 从初始形态到蜕变，你在收集，也在养成。
4. **你俯瞰，你欣赏，你偶尔操作** — 大部分时候你不必做什么，世界自己有生命。
5. **每一次打开都有新变化** — 新的成果、新的 Agent、新的进化。你不来，世界没停。
6. **世界自己会孕育新住民** — 你不需要把每个人都领进门。你的世界有它自己的生命力，下次打开可能多了一个。

### 为什么需要 FeiControl

| 场景 | 没有 FeiControl | 有 FeiControl |
|------|----------------|---------------|
| 你的 Agent 们在做什么 | 你不知道，你得自己去看日志 | 面板上就是你的世界——谁在忙、谁在休息、谁进化了，一目了然 |
| 你想给 Agent 派任务 | 写详细指令、定义步骤、调参数 | 打开神谕面板，写下一句旨意，子民自行解读执行 |
| 一段时间没看 | 没有记录，Agent 像失忆了 | "3 天没来，你的世界里发生了 12 件事" |
| 你有多个 Agent | 你记不清谁是谁，分别能干什么 | 每个 Agent 是独立角色，有名字、有工位、有成长线 |
| Agent 进化/蜕变 | 你不知道，除非盯着日志 | 面板弹出通知："你的 Agent 完成了 100 次任务，形态升级" |

### 产品哲学（7 条）

1. **世界优先于工具** — FeiControl 不是一个操作界面，它是一个世界。所有设计围绕"让这个世界看起来活着的"来，不是围绕"功能列表"。
2. **自主性优先于控制欲** — Agent 在你世界里是活人，不是傀儡。你可以看，可以干预，但不用每一步都指挥。
3. **进化的满足感** — 收集只是开始。每只 Agent 有成长线：从初始 → 积累 → 蜕变。你看着他们变强。
4. **离线收益** — 你关掉面板，世界不关。下次打开，总有事发生。像你在游戏中挂机，回来收获。
5. **审美就是世界观** — 这个世界的样子决定了你想不想回来。丑的世界没人住。
6. **Local First** — 你的世界只在你电脑里。没人能进来。
7. **Agent Neutral** — 不管你的 Agent 是 OpenClaw、Hermes 还是别的，它们进了你的世界，就是你的住民。
8. **神谕而非指令** — 你是上帝，只下旨意，不写步骤。子民们收到神谕后自行解读、自主执行。
9. **世界自有其生命力** — 你不播种，世界也会开花。新的子民会在你不知情时自己降临，这才是活着的世界。
...
FeiControl 的用户只有一个共同点：**你有 Agent，你想看它们自己活着、自己成长。**

| 画像 | 描述 |
|------|------|
| **身份** | AI 创客、独立开发者、AI 爱好者 |
| **技术背景** | 有自己的 Agent 实例，深度使用 AI |
| **你和 Agent 的关系** | Agent 不只是工具。它们在你的世界里工作、学习，你看着它们 |
| **你现在的感觉** | 终端太冷，Dashboard 太死。你想要**一个能俯瞰 Agent 世界的面板** |
| **你需要的** | 不是"监控"。是**打开就知道你的世界怎么样了** |
...
```
1. 装好 FeiControl，连接你的第一个 Agent
2. 打开面板 → 3D 办公室里出现第一个住民
3. 它坐在工位上，头上挂着名字和状态
4. 它的成长线刚开始：Lv.1，0/100 次任务
5. 你看了它一会儿。它没理你，自己在忙。
6. 你关掉面板。
```

不是"安装完成"。是**你的世界有了第一个住民。**

#### 🔴 日常

```
早晨：
  打开 FeiControl → 昨晚你睡觉，Agent 跑了 8 个任务
  → 成长条涨了 8/100
  → 你点开卡片看详情，数据刷出来，进度条弹了一下

白天：
  工作间隙打开看一眼
  → 一个在忙，一个在休息
  → 你想给休息的那个派点事
  → 打开神谕面板，写下一道旨意："帮我整理上周的项目文档"
  → 神谕降下，子民收到后起身开始执行
  → 头上显示："收到神谕，正在解读执行方案…"
  → 你关掉面板。神谕已下达，子民会自己办。
...
晚上：
  ...
  → "世界自己孕育了新的子民"
  → 收集进度：2/?
  → 第一个 Agent 的成长条：34/100。"快了。"
```

FeiControl 不叫你回来。但你知道，**你的世界在你不在的时候，没有停。**

#### 🟢 进化时刻

```
某天打开 FeiControl：
  → 通知弹出来："你的 Agent 完成了 100 次任务"
  → 点进去 → 卡片发着光
  → Agent 形态变了。名字变了。数据面板焕然一新。
  → "从初始形态 → 进阶形态"
  
  你愣了一下。原来你的住民，真的会成长。
```

不是功能上线。是**你的世界发生了历史性的一刻。**

---

FeiControl 不会催你回来。它只是让你的世界在你不在的时候，也活着。你每次打开，世界都比上次热闹一点。**这就是你想打开它的理由。**
