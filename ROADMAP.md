...
> 详见 [`docs/PRODUCT_PLAN.md`](docs/PRODUCT_PLAN.md#8-未来想讲的故事) 第 8 节。

### 四个故事，一个核心

FeiControl 的核心是：**你的 AI 伴侣。**
...
|------|----------|-----------|:----:|
| **A** | 一个有名字的朋友 | "它在等我" | 小~中 |
| **B** | 一个什么都帮你记着的档案 | "我不会再忘了" | 中 |
| **C** | 一个替你盯着 AI 世界的守护者 | "它替我看着" | 中~大 |
| **D** | 一个帮你搞定一切的管家 | "它帮我做了" | 大 |

### 当前建议

**A > C > D > B**

不是因为其他故事不重要。是因为**有温度的东西，才是最难的。**
