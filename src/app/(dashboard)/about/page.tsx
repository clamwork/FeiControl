...
export default function AboutPage() {
  ...
  // Skills with i18n
  const skills = [
    { name: t("about.skills.telegram"), icon: MessageSquare, color: "#0088cc" },
    { name: t("about.skills.twitter"), icon: Twitter, color: "#1DA1F2" },
    { name: t("about.skills.web_search"), icon: Search, color: "#facc15" },
    { name: t("about.skills.file_management"), icon: FileText, color: "#60a5fa" },
    { name: t("about.skills.cron_scheduler"), icon: Timer, color: "#f472b6" },
    { name: t("about.skills.memory_system"), icon: Brain, color: "#34d399" },
    { name: t("about.skills.youtube"), icon: Youtube, color: "#FF0000" },
    { name: t("about.skills.email"), icon: Mail, color: "#EA4335" },
  ];
      ...
      >
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span
            ...
            style={{ color: "var(--text-secondary)" }}
          >
            {t("about.footer.built_with")} <span style={{ color: "var(--accent)" }}>♥</span> on{" "}
            <a
        ...
        <p className="text-xs" style={{ color: "var(--text-muted)" }}>
          {agentName} {agentEmoji} {t("about.footer.tagline")}
        </p>
      </div>
    </div>
  );
